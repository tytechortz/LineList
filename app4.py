...
print(list(raw_case_df.columns))
# case_df = raw_case_df.drop(raw_case_df.columns[np.r_[:3,8,12,13,18,20:25]], 1)
...
# case_df.drop(case_df.iloc[:, 20:29], inplace=True, axis=1)
